...
function renderAccessorySvg(upgrade) {
  ...
  if (id === 'greenSneakers') return wrap(`
    <g transform="translate(0,-1)">
      <path d="M95 231 q14 0 22 11 v8 h-28 q0 -11 6 -19z" fill="#53c26f" stroke="#2b8a3e" stroke-width="3"/>
      <path d="M143 231 q14 0 22 11 v8 h-28 q0 -11 6 -19z" fill="#53c26f" stroke="#2b8a3e" stroke-width="3"/>
      <path d="M93 244 h24 M141 244 h24" stroke="#fff" stroke-width="3" stroke-linecap="round"/>
      <path d="M99 238 h10 M147 238 h10" stroke="#e6fff0" stroke-width="2.5" stroke-linecap="round"/>
    </g>
  `);
...
function renderAccessoryCardSvg(id) {
  ...
  if (id === 'greenSneakers') return wrap(`<path d="M17 33 q9 0 14 7 v5 h-18 q0 -7 4 -12z" fill="#53c26f" stroke="#2b8a3e" stroke-width="2.2"/><path d="M39 33 q9 0 14 7 v5 h-18 q0 -7 4 -12z" fill="#53c26f" stroke="#2b8a3e" stroke-width="2.2"/><path d="M14 42 h15 M36 42 h15" stroke="#fff" stroke-width="2.2" stroke-linecap="round"/>`);
...
function getSafeResumeScreen() {
  ...
  if (completedCount() >= 5) return state.finalShown ? 'final' : 'finalBase';
...
function renderFinalScreen() {
  app.innerHTML = `
    <section class="card">
      ...
      ${renderOtterPanel('Your fully upgraded Eco Otter is ready. You can download it as a souvenir when you finish.')}
      ${renderStampArt()}
      ...
      <div class="actions"><button class="secondary-btn" id="copySummary">Copy Completion Summary</button><button class="primary-btn" id="downloadAvatar">Download Eco Otter</button></div>
    </section>`;
...
function downloadFinalAvatar() {
  ...
  const safeTeam = (state.teamName || 'team').replace(/[^a-z0-9]+/gi, '_');
  a.href = url;
  ...
  showToast('Eco Otter download started.');
}
