...
const UPGRADE_SLOTS = {
  S1: { slot: 'headgear', label: 'headgear upgrade', options: [
    { id: 'gardenHat', name: 'Garden Explorer Hat', emoji: '🪴' },
  ...
  S3: { slot: 'movement', label: 'movement upgrade', options: [
    ...
    { id: 'greenSneakers', name: 'Mini Bicycle', emoji: '🚲' }
  ]},
...
function renderAccessorySvg(upgrade) {
  if (!upgrade) return '';
  const id = upgrade.id || '';
  const wrap = inner => `<g class="upgrade-svg ${escapeHtml(id)}">${inner}</g>`;

  if (id === 'gardenHat') return wrap(`
    <g transform="translate(0,-3)">
      <ellipse cx="132" cy="48" rx="44" ry="11" fill="#e7c77b" stroke="#b8883f" stroke-width="3"/>
      <path d="M102 46 Q132 14 162 46 L157 56 Q132 61 107 56 Z" fill="#f4dea2" stroke="#b8883f" stroke-width="3"/>
      <path d="M108 47 Q132 26 156 47" fill="none" stroke="#7aba63" stroke-width="6" stroke-linecap="round"/>
      <path d="M139 23 q10 2 13 10 q-10 3 -16 -4 q-3 -5 3 -6z" fill="#5aa469"/>
      <circle cx="126" cy="42" r="2.6" fill="#ef233c"/><circle cx="132" cy="42" r="2.6" fill="#ffffff"/><circle cx="138" cy="42" r="2.6" fill="#ffd166"/><circle cx="144" cy="42" r="2.6" fill="#111111"/>
    </g>
  `);

  if (id === 'flowerHat') return wrap(`
    <g transform="translate(0,-2)">
      <ellipse cx="132" cy="48" rx="42" ry="11" fill="#e8d0a0" stroke="#bc9358" stroke-width="3"/>
      <path d="M104 47 Q132 18 160 47 L156 55 Q132 59 108 55 Z" fill="#f8e6c0" stroke="#bc9358" stroke-width="3"/>
      <g transform="translate(103 18)">
        <path d="M7 23 q8 -14 17 0 q-8 9 -17 0z" fill="#ff7aa2"/><circle cx="15.5" cy="22" r="2.2" fill="#fff6b0"/>
        <path d="M24 12 q8 -14 17 0 q-8 9 -17 0z" fill="#ffd166"/><circle cx="32.5" cy="11" r="2.2" fill="#fff"/>
        <path d="M39 21 q8 -14 17 0 q-8 9 -17 0z" fill="#8fd3ff"/><circle cx="47.5" cy="20" r="2.2" fill="#fff"/>
        <path d="M53 14 q8 -14 17 0 q-8 9 -17 0z" fill="#ffa94d"/><circle cx="61.5" cy="13" r="2.2" fill="#fff"/>
        <path d="M3 28 Q36 37 69 27" fill="none" stroke="#6cab5b" stroke-width="4" stroke-linecap="round"/>
      </g>
    </g>
  `);

  if (id === 'toteBadge') return wrap(`
    <g transform="translate(0,0)">
      <path d="M164 128 q18 12 20 39" fill="none" stroke="#7c5737" stroke-width="5" stroke-linecap="round"/>
      <path d="M159 152 h28 a5 5 0 0 1 5 5 v30 a7 7 0 0 1 -7 7 h-24 a7 7 0 0 1 -7 -7 v-30 a5 5 0 0 1 5 -5 z" fill="#7fd6b0" stroke="#0b7f8a" stroke-width="3"/>
      <path d="M165 154 q8 -10 16 0" fill="none" stroke="#0b7f8a" stroke-width="3" stroke-linecap="round"/>
      <path d="M165 168 h15" stroke="#ef233c" stroke-width="3" stroke-linecap="round"/>
      <path d="M165 174 h18" stroke="#ffd166" stroke-width="3" stroke-linecap="round"/>
      <path d="M165 180 h12" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/>
      <path d="M181 173 q4 -7 9 0 q-3 5 -9 0z" fill="#5aa469"/>
    </g>
  `);

  if (id === 'judgeBadge') return wrap(`
    <g transform="translate(0,2)">
      <circle cx="132" cy="166" r="17" fill="#ffd166" stroke="#d68e1c" stroke-width="3"/>
      <path d="M123 179 l-5 16 12 -6 12 6 -5 -16" fill="#ef233c" opacity=".92"/>
      <path d="M127 165 q4 -7 8 0 q-4 5 -8 0z" fill="#ffffff"/>
      <circle cx="132" cy="165" r="3.1" fill="#111"/>
      <path d="M126 171 l6 -3 6 3" fill="none" stroke="#111" stroke-width="2" stroke-linecap="round"/>
    </g>
  `);

  if (id === 'tinyWheels') return wrap(`
    <g transform="translate(0,-1)">
      <rect x="94" y="231" width="30" height="9" rx="4.5" fill="#5cc8ff" stroke="#0b7f8a" stroke-width="3"/>
      <rect x="140" y="231" width="30" height="9" rx="4.5" fill="#5cc8ff" stroke="#0b7f8a" stroke-width="3"/>
      <circle cx="103" cy="244" r="6" fill="#173846"/><circle cx="117" cy="244" r="6" fill="#173846"/>
      <circle cx="149" cy="244" r="6" fill="#173846"/><circle cx="163" cy="244" r="6" fill="#173846"/>
    </g>
  `);

  if (id === 'greenSneakers') return wrap(`
    <g transform="translate(0,2)">
      <circle cx="103" cy="236" r="13" fill="none" stroke="#1f3344" stroke-width="4"/>
      <circle cx="160" cy="236" r="13" fill="none" stroke="#1f3344" stroke-width="4"/>
      <path d="M103 236 L126 212 L142 236 Z" fill="none" stroke="#2b8a3e" stroke-width="4" stroke-linejoin="round"/>
      <path d="M126 212 L143 212" fill="none" stroke="#2b8a3e" stroke-width="4" stroke-linecap="round"/>
      <path d="M142 236 L152 218" fill="none" stroke="#2b8a3e" stroke-width="4" stroke-linecap="round"/>
      <path d="M126 212 l-8 -7" fill="none" stroke="#2b8a3e" stroke-width="4" stroke-linecap="round"/>
      <path d="M152 218 h9" fill="none" stroke="#2b8a3e" stroke-width="4" stroke-linecap="round"/>
      <path d="M100 219 h14" fill="none" stroke="#5cc8ff" stroke-width="4" stroke-linecap="round"/>
      <circle cx="126" cy="212" r="3.6" fill="#ffd166"/>
    </g>
  `);

  if (id === 'sgBruneiScarf') return wrap(`
    <g transform="translate(0,-2)">
      <path d="M99 138 q33 16 66 0" fill="none" stroke="#ef233c" stroke-width="8" stroke-linecap="round"/>
      <path d="M101 145 q31 14 62 0" fill="none" stroke="#ffffff" stroke-width="7" stroke-linecap="round" opacity=".95"/>
      <path d="M103 151 q29 12 58 0" fill="none" stroke="#ffd166" stroke-width="8" stroke-linecap="round"/>
      <path d="M145 145 v27" stroke="#ef233c" stroke-width="7" stroke-linecap="round"/>
      <path d="M154 148 v23" stroke="#ffd166" stroke-width="7" stroke-linecap="round"/>
      <path d="M110 146 h7 M120 146 h7 M131 146 h7" stroke="#111" stroke-width="2.5" stroke-linecap="round"/>
    </g>
  `);

  if (id === 'cityBandana') return wrap(`
    <g transform="translate(0,-1)">
      <path d="M102 140 h60 l-11 18 -19 -8 -19 8 z" fill="#2fbf71" stroke="#1a8b4e" stroke-width="3" stroke-linejoin="round"/>
      <path d="M118 147 h5 v-5 h4 v5 h4 v-8 h4 v8 h5" stroke="#ffffff" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
  `);

  if (id === 'reusableBottle') return wrap(`
    <g transform="translate(0,4)">
      <rect x="168" y="145" width="18" height="42" rx="8" fill="#74c0fc" stroke="#087f8c" stroke-width="3"/>
      <rect x="172" y="137" width="10" height="11" rx="3" fill="#087f8c"/>
      <path d="M171 161 h12" stroke="#ffffff" stroke-width="3" stroke-linecap="round"/>
      <path d="M174 171 q4 -6 8 0" fill="none" stroke="#ffffff" stroke-width="2.4" stroke-linecap="round"/>
    </g>
  `);

  if (id === 'snackPouch') return wrap(`
    <g transform="translate(0,2)">
      <path d="M158 153 h28 v31 q0 7 -7 7 h-14 q-7 0 -7 -7 z" fill="#ffd166" stroke="#ff922b" stroke-width="3"/>
      <path d="M161 160 h22" stroke="#ef233c" stroke-width="2.8" stroke-linecap="round"/>
      <path d="M162 166 h18" stroke="#ffffff" stroke-width="2.8" stroke-linecap="round"/>
      <path d="M163 172 h20" stroke="#111" stroke-width="2.8" stroke-linecap="round"/>
      <path d="M167 180 q5 -7 10 0" fill="none" stroke="#7c5737" stroke-width="3" stroke-linecap="round"/>
    </g>
  `);
...
function renderAccessoryCardSvg(id) {
  ...
  if (id === 'gardenHat') return wrap(`<ellipse cx="35" cy="38" rx="20" ry="6" fill="#e7c77b" stroke="#b8883f" stroke-width="2"/><path d="M21 36 Q35 17 49 36 L46 42 Q35 45 24 42 Z" fill="#f4dea2" stroke="#b8883f" stroke-width="2"/><path d="M25 37 Q35 28 45 37" fill="none" stroke="#7aba63" stroke-width="3.2" stroke-linecap="round"/>`);
  if (id === 'flowerHat') return wrap(`<ellipse cx="35" cy="38" rx="20" ry="6" fill="#e8d0a0" stroke="#bc9358" stroke-width="2"/><path d="M21 36 Q35 20 49 36 L46 41 Q35 44 24 41 Z" fill="#f8e6c0" stroke="#bc9358" stroke-width="2"/><circle cx="24" cy="24" r="4" fill="#ff7aa2"/><circle cx="34" cy="20" r="4" fill="#ffd166"/><circle cx="44" cy="24" r="4" fill="#8fd3ff"/>`);
  if (id === 'toteBadge') return wrap(`<path d="M22 22 q9 -8 13 0" fill="none" stroke="#0b7f8a" stroke-width="2.4" stroke-linecap="round"/><rect x="20" y="22" width="28" height="24" rx="5" fill="#7fd6b0" stroke="#0b7f8a" stroke-width="2.2"/><path d="M24 31 h18" stroke="#ef233c" stroke-width="2.2" stroke-linecap="round"/><path d="M24 37 h20" stroke="#ffd166" stroke-width="2.2" stroke-linecap="round"/>`);
  if (id === 'judgeBadge') return wrap(`<circle cx="35" cy="28" r="12" fill="#ffd166" stroke="#d68e1c" stroke-width="2.4"/><path d="M28 39 l-4 11 11 -5 11 5 -4 -11" fill="#ef233c"/><path d="M30 28 q5 -8 10 0" fill="#fff"/>`);
  if (id === 'tinyWheels') return wrap(`<rect x="17" y="28" width="15" height="6" rx="3" fill="#5cc8ff" stroke="#0b7f8a" stroke-width="2"/><rect x="38" y="28" width="15" height="6" rx="3" fill="#5cc8ff" stroke="#0b7f8a" stroke-width="2"/><circle cx="22" cy="39" r="4" fill="#173846"/><circle cx="29" cy="39" r="4" fill="#173846"/><circle cx="43" cy="39" r="4" fill="#173846"/><circle cx="50" cy="39" r="4" fill="#173846"/>`);
  if (id === 'greenSneakers') return wrap(`<circle cx="21" cy="39" r="7" fill="none" stroke="#1f3344" stroke-width="2.6"/><circle cx="49" cy="39" r="7" fill="none" stroke="#1f3344" stroke-width="2.6"/><path d="M21 39 L32 24 L40 39 Z" fill="none" stroke="#2b8a3e" stroke-width="2.6" stroke-linejoin="round"/><path d="M32 24 L41 24" fill="none" stroke="#2b8a3e" stroke-width="2.6" stroke-linecap="round"/><path d="M40 39 L45 29" fill="none" stroke="#2b8a3e" stroke-width="2.6" stroke-linecap="round"/><path d="M32 24 l-5 -4" fill="none" stroke="#2b8a3e" stroke-width="2.6" stroke-linecap="round"/><path d="M45 29 h5" fill="none" stroke="#2b8a3e" stroke-width="2.6" stroke-linecap="round"/><circle cx="32" cy="24" r="2.1" fill="#ffd166"/>`);
  if (id === 'sgBruneiScarf') return wrap(`<path d="M16 24 q19 10 38 0" fill="none" stroke="#ef233c" stroke-width="5" stroke-linecap="round"/><path d="M18 29 q17 8 34 0" fill="none" stroke="#ffd166" stroke-width="5" stroke-linecap="round"/><path d="M43 25 v16" stroke="#ef233c" stroke-width="5" stroke-linecap="round"/><path d="M50 28 v14" stroke="#ffd166" stroke-width="5" stroke-linecap="round"/>`);
  if (id === 'cityBandana') return wrap(`<path d="M16 24 h38 l-6 11 -13 -5 -13 5 z" fill="#2fbf71" stroke="#1a8b4e" stroke-width="2.2"/><path d="M26 28 h3 v-4 h3 v4 h3 v-6 h3 v6 h3" stroke="#fff" stroke-width="2" fill="none" stroke-linecap="round"/>`);
  if (id === 'reusableBottle') return wrap(`<rect x="28" y="14" width="14" height="28" rx="6" fill="#74c0fc" stroke="#087f8c" stroke-width="2.2"/><rect x="31" y="9" width="8" height="7" rx="2" fill="#087f8c"/><path d="M31 24 h8" stroke="#fff" stroke-width="2" stroke-linecap="round"/>`);
  if (id === 'snackPouch') return wrap(`<rect x="19" y="18" width="30" height="24" rx="6" fill="#ffd166" stroke="#ff922b" stroke-width="2.2"/><path d="M22 25 h24" stroke="#ef233c" stroke-width="2" stroke-linecap="round"/><path d="M23 31 h18" stroke="#fff" stroke-width="2" stroke-linecap="round"/><path d="M25 37 q5 -6 10 0" fill="none" stroke="#7c5737" stroke-width="2.4" stroke-linecap="round"/>`);
  return wrap('');
}
...
function renderOtter() {
  ...
  const accessoryMarkup = upgrades.map(renderAccessorySvg).join('');
  return `
    <div class="otter-wrap" aria-label="Eco Otter preview">
      <svg class="otter-svg" viewBox="0 0 260 280" role="img" aria-hidden="true">
        <ellipse cx="130" cy="252" rx="58" ry="14" fill="rgba(18,48,58,.10)"/>
        <path d="M171 213 C204 205 212 179 196 159 C179 139 163 160 160 183 C158 199 160 210 171 213 Z" fill="#8a5a37"/>
        <path d="M92 224 C64 208 55 176 79 158 C104 139 117 164 118 189 C119 208 111 221 92 224 Z" fill="#8a5a37"/>
        <ellipse cx="133" cy="170" rx="48" ry="66" fill="#a96e44"/>
        <ellipse cx="133" cy="183" rx="30" ry="45" fill="#f7ddb8"/>
        <ellipse cx="132" cy="87" rx="47" ry="43" fill="#a96e44"/>
        <circle cx="99" cy="63" r="18" fill="#915d38"/>
        <circle cx="165" cy="63" r="18" fill="#915d38"/>
        <circle cx="99" cy="63" r="8" fill="#c79268"/>
        <circle cx="165" cy="63" r="8" fill="#c79268"/>
        <ellipse cx="132" cy="100" rx="30" ry="21" fill="#f7ddb8"/>
        <circle cx="118" cy="84" r="5.8" fill="#173846"/>
        <circle cx="146" cy="84" r="5.8" fill="#173846"/>
        <ellipse cx="132" cy="95" rx="6" ry="4.5" fill="#173846"/>
        <path d="M124 105 q8 8 16 0" fill="none" stroke="#173846" stroke-width="4" stroke-linecap="round"/>
        <path d="M95 145 q-22 22 -15 53" fill="none" stroke="#8a5a37" stroke-width="18" stroke-linecap="round"/>
        <path d="M169 145 q22 22 15 53" fill="none" stroke="#8a5a37" stroke-width="18" stroke-linecap="round"/>
        <ellipse cx="110" cy="238" rx="16" ry="11" fill="#6f472c"/>
        <ellipse cx="154" cy="238" rx="16" ry="11" fill="#6f472c"/>
        ${accessoryMarkup}
      </svg>
    </div>`;
}
...
function renderStampArt() {
  const count = Math.max(0, Math.min(5, completedCount()));
...
function buildOtterSvgMarkup() {
  const upgrades = Object.values(state.upgrades || {}).map(renderAccessorySvg).join('');
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 280" role="img" aria-label="Eco Otter">
    <ellipse cx="130" cy="252" rx="58" ry="14" fill="rgba(18,48,58,.10)"/>
    <path d="M171 213 C204 205 212 179 196 159 C179 139 163 160 160 183 C158 199 160 210 171 213 Z" fill="#8a5a37"/>
    <path d="M92 224 C64 208 55 176 79 158 C104 139 117 164 118 189 C119 208 111 221 92 224 Z" fill="#8a5a37"/>
    <ellipse cx="133" cy="170" rx="48" ry="66" fill="#a96e44"/>
...
function downloadFinalAvatar() {
  const svg = buildOtterSvgMarkup();
  ...
  img.onload = () => {
    try {
      ...
      canvas.toBlob(blob => {
        ...
        if (!blob) {
          downloadAvatarSvgFallback(svg, safeTeam);
          return;
        }
...
function downloadAvatarSvgFallback(svg, safeTeam) {
  const blob = new Blob([svg], { type: 'image/svg+xml;charset=utf-8' });
  const url = URL.createObjectURL(blob);
  const a = document.createElement('a');
  a.href = url;
  a.download = `EcoOtter_${safeTeam}.svg`;
  document.body.appendChild(a);
  a.click();
  a.remove();
  URL.revokeObjectURL(url);
  showToast('PNG conversion failed on this browser, so SVG was downloaded instead.');
}
