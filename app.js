...
function renderAccessoryCardSvg(id) {
  ...
  if (id === 'gardenHat') return wrap(`<ellipse cx="35" cy="34" rx="23" ry="6" fill="#e7c77b" stroke="#b8883f" stroke-width="2"/><path d="M22 33 Q35 13 48 33 L45 39 Q35 42 25 39 Z" fill="#f4dea2" stroke="#b8883f" stroke-width="2"/><path d="M25 34 Q35 25 45 34" fill="none" stroke="#4d7f47" stroke-width="3.2" stroke-linecap="round"/><path d="M40 18 q7 2 9 8 q-7 2 -11 -3 q-2 -4 2 -5z" fill="#5f8f56"/>`);
  if (id === 'flowerHat') return wrap(`<ellipse cx="35" cy="34" rx="23" ry="6" fill="#dfb57a" stroke="#bc9358" stroke-width="2"/><path d="M22 33 Q35 16 48 33 L45 39 Q35 42 25 39 Z" fill="#f4d38d" stroke="#bc9358" stroke-width="2"/><circle cx="24" cy="22" r="4" fill="#f58bac"/><circle cx="34" cy="18" r="5" fill="#fff3b2"/><circle cx="44" cy="22" r="4" fill="#ffcf73"/><path d="M22 28 Q35 34 49 28" fill="none" stroke="#6cab5b" stroke-width="2.5" stroke-linecap="round"/>`);
  if (id === 'toteBadge') return wrap(`<path d="M21 24 q9 -9 18 0" fill="none" stroke="#809558" stroke-width="2.4" stroke-linecap="round"/><rect x="18" y="24" width="31" height="27" rx="4" fill="#dcd2b8" stroke="#809558" stroke-width="2.2"/><path d="M27 37 q7 -10 14 0" fill="none" stroke="#729753" stroke-width="2.3" stroke-linecap="round"/><path d="M27 41 q7 5 14 0" fill="none" stroke="#d3b34c" stroke-width="2.3" stroke-linecap="round"/>`);
  if (id === 'judgeBadge') return wrap(`<circle cx="35" cy="27" r="12" fill="#d8d2a1" stroke="#81935c" stroke-width="2.4"/><path d="M29 38 l-4 12 10 -5 10 5 -4 -12" fill="#809558"/><path d="M31 27 q4 -7 8 0 q-4 4 -8 0z" fill="#ffffff"/><path d="M30 33 h10" stroke="#4c7547" stroke-width="2" stroke-linecap="round"/>`);
  if (id === 'tinyWheels') return wrap(`<path d="M16 30 h18 q2 0 3 2 l3 7 h-28 l3 -7 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="2"/><path d="M37 30 h18 q2 0 3 2 l3 7 h-28 l3 -7 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="2"/><circle cx="21" cy="43" r="4.2" fill="#3d454d"/><circle cx="32" cy="43" r="4.2" fill="#3d454d"/><circle cx="42" cy="43" r="4.2" fill="#3d454d"/><circle cx="53" cy="43" r="4.2" fill="#3d454d"/>`);
  if (id === 'greenSneakers') return wrap(`<circle cx="20" cy="40" r="8" fill="none" stroke="#495057" stroke-width="2.8"/><circle cx="51" cy="40" r="8" fill="none" stroke="#495057" stroke-width="2.8"/><path d="M20 40 L32 27 L43 27 L51 40" fill="none" stroke="#5f8f56" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M32 27 l-6 -5 M43 27 l8 -4" fill="none" stroke="#5f8f56" stroke-width="3" stroke-linecap="round"/><rect x="36" y="22" width="10" height="3" rx="1.5" fill="#7c5737"/><circle cx="36" cy="27" r="2.2" fill="#d2b559"/>`);
  if (id === 'sgBruneiScarf') return wrap(`<path d="M16 24 q19 9 38 0" fill="none" stroke="#d65746" stroke-width="5" stroke-linecap="round"/><path d="M18 29 q17 8 34 0" fill="none" stroke="#efb93f" stroke-width="5" stroke-linecap="round"/><path d="M42 27 v17" stroke="#d65746" stroke-width="5" stroke-linecap="round"/><path d="M50 29 v16" stroke="#efb93f" stroke-width="5" stroke-linecap="round"/><path d="M21 34 h8" stroke="#fff" stroke-width="1.5" stroke-linecap="round"/>`);
  if (id === 'cityBandana') return wrap(`<path d="M16 24 h38 l-7 13 -12 -5 -12 5 z" fill="#567d4f" stroke="#3b5f38" stroke-width="2.2"/><path d="M26 29 h4 l2 -4 h3 v4 h3 v-6 h3 v6 h4" stroke="#f5f8ee" stroke-width="1.8" fill="none" stroke-linecap="round"/>`);
  if (id === 'reusableBottle') return wrap(`<rect x="29" y="15" width="14" height="30" rx="6" fill="#a2aa7b" stroke="#6f7748" stroke-width="2.2"/><rect x="32" y="9" width="8" height="8" rx="2" fill="#6f7748"/><path d="M31 29 q5 -4 10 0" fill="none" stroke="#ffffff" stroke-width="1.8" stroke-linecap="round"/><path d="M31 36 h10" stroke="#d1e3bc" stroke-width="2" stroke-linecap="round"/>`);
  if (id === 'snackPouch') return wrap(`<path d="M21 20 h28 v25 q0 5 -5 5 h-18 q-5 0 -5 -5 z" fill="#dfc160" stroke="#a78632" stroke-width="2.2"/><path d="M22 23 q13 -8 26 0" fill="none" stroke="#719453" stroke-width="2.2" stroke-linecap="round"/><circle cx="32" cy="34" r="3" fill="#e1a735"/><circle cx="40" cy="36" r="2.5" fill="#7d5a32"/><circle cx="34" cy="42" r="3" fill="#9b6b3e"/>`);
  return wrap('');
}
...
function renderAccessorySvg(upgrade, layer = 'front') {
  ...
  if (id === 'gardenHat') return layer === 'front' ? wrap(`
    <g transform="translate(0,-34)">
      <ellipse cx="132" cy="48" rx="43" ry="10" fill="#e7c77b" stroke="#b8883f" stroke-width="3"/>
      <path d="M103 46 Q132 18 161 46 L156 54 Q132 59 108 54 Z" fill="#f4dea2" stroke="#b8883f" stroke-width="3"/>
      <path d="M108 47 Q132 29 156 47" fill="none" stroke="#4d7f47" stroke-width="6" stroke-linecap="round"/>
      <path d="M141 25 q10 2 13 10 q-10 3 -16 -4 q-3 -5 3 -6z" fill="#5f8f56"/>
      <path d="M121 42 h34" stroke="#d8d46d" stroke-width="2" stroke-linecap="round" opacity=".75"/>
    </g>
  `) : '';

  if (id === 'flowerHat') return layer === 'front' ? wrap(`
    <g transform="translate(0,-36)">
      <ellipse cx="132" cy="49" rx="42" ry="10" fill="#dfb57a" stroke="#bc9358" stroke-width="3"/>
      <path d="M104 47 Q132 22 160 47 L156 55 Q132 60 108 55 Z" fill="#f4d38d" stroke="#bc9358" stroke-width="3"/>
      <g transform="translate(104 21)">
        <circle cx="14" cy="17" r="7" fill="#f58bac"/><circle cx="14" cy="17" r="2.1" fill="#fff4be"/>
        <circle cx="32" cy="12" r="9" fill="#fff3b2"/><circle cx="32" cy="12" r="2.2" fill="#fff"/>
        <circle cx="49" cy="18" r="7" fill="#ffcf73"/><circle cx="49" cy="18" r="2.1" fill="#fff"/>
        <circle cx="63" cy="14" r="6" fill="#f2a2bf"/><circle cx="63" cy="14" r="1.8" fill="#fff"/>
        <path d="M2 27 Q34 33 67 27" fill="none" stroke="#6cab5b" stroke-width="4" stroke-linecap="round"/>
      </g>
    </g>
  `) : '';
  ...
  if (id === 'toteBadge') return layer === 'front' ? wrap(`
    <g transform="translate(-104,6)">
      <path d="M166 126 q12 10 14 28" fill="none" stroke="#7c5737" stroke-width="5" stroke-linecap="round"/>
      <path d="M157 150 h34 a5 5 0 0 1 5 5 v34 a7 7 0 0 1 -7 7 h-30 a7 7 0 0 1 -7 -7 v-34 a5 5 0 0 1 5 -5 z" fill="#dcd2b8" stroke="#809558" stroke-width="3"/>
      <path d="M166 152 q8 -10 16 0" fill="none" stroke="#809558" stroke-width="3" stroke-linecap="round"/>
      <path d="M166 171 q10 -14 20 0" fill="none" stroke="#729753" stroke-width="3" stroke-linecap="round"/>
      <path d="M168 176 q9 6 18 0" fill="none" stroke="#d3b34c" stroke-width="3" stroke-linecap="round"/>
      <path d="M160 185 h28" stroke="#809558" stroke-width="3" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'judgeBadge') return layer === 'front' ? wrap(`
    <g transform="translate(0,-10)">
      <circle cx="132" cy="166" r="15" fill="#d8d2a1" stroke="#81935c" stroke-width="3"/>
      <path d="M124 178 l-4 14 12 -6 12 6 -4 -14" fill="#809558" opacity=".95"/>
      <path d="M126 165 q5 -8 10 0 q-5 5 -10 0z" fill="#ffffff"/>
      <path d="M126 171 h12" stroke="#4c7547" stroke-width="2.4" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'tinyWheels') return layer === 'back' ? wrap(`
    <g transform="translate(0,3)">
      <path d="M95 230 h26 q2 0 3 2 l4 8 h-37 l4 -8 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="3"/>
      <path d="M143 230 h26 q2 0 3 2 l4 8 h-37 l4 -8 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="3"/>
      <circle cx="103" cy="245" r="6" fill="#3d454d"/><circle cx="119" cy="245" r="6" fill="#3d454d"/>
      <circle cx="151" cy="245" r="6" fill="#3d454d"/><circle cx="167" cy="245" r="6" fill="#3d454d"/>
    </g>
  `) : '';

  if (id === 'greenSneakers') return layer === 'back' ? wrap(`
    <g transform="translate(0,-2)">
      <circle cx="58" cy="247" r="25" fill="none" stroke="#495057" stroke-width="4"/>
      <circle cx="206" cy="247" r="25" fill="none" stroke="#495057" stroke-width="4"/>
      <path d="M58 247 L109 204 L156 204 L206 247" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M109 204 L92 194" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M156 204 L174 194" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M156 204 L173 224" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M109 204 L134 247" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M134 247 L156 204" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <rect x="141" y="189" width="18" height="4" rx="2" fill="#7c5737"/>
      <path d="M174 194 l16 -8" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <circle cx="134" cy="247" r="4" fill="#d2b559"/>
    </g>
  `) : '';

  if (id === 'sgBruneiScarf') return layer === 'front' ? wrap(`
    <g transform="translate(0,-26)">
      <path d="M103 139 q29 13 58 0" fill="none" stroke="#efb93f" stroke-width="9" stroke-linecap="round"/>
      <path d="M100 135 q31 13 62 0" fill="none" stroke="#d65746" stroke-width="9" stroke-linecap="round"/>
      <path d="M144 139 v31" stroke="#d65746" stroke-width="8" stroke-linecap="round"/>
      <path d="M154 142 v27" stroke="#efb93f" stroke-width="8" stroke-linecap="round"/>
      <path d="M146 149 h8" stroke="#fff" stroke-width="2" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'cityBandana') return layer === 'front' ? wrap(`
    <g transform="translate(0,-25)">
      <path d="M102 140 h60 l-11 18 -19 -8 -19 8 z" fill="#567d4f" stroke="#3b5f38" stroke-width="3" stroke-linejoin="round"/>
      <path d="M116 148 h6 l2 -4 h4 v4 h4 v-6 h4 v6 h4" stroke="#f5f8ee" stroke-width="2.5" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
    </g>
  `) : '';

  if (id === 'reusableBottle') return layer === 'front' ? wrap(`
    <g transform="translate(-105,33)">
      <rect x="170" y="146" width="18" height="42" rx="8" fill="#a2aa7b" stroke="#6f7748" stroke-width="3"/>
      <rect x="173" y="137" width="12" height="12" rx="3" fill="#6f7748"/>
      <path d="M173 163 q6 -5 12 0" fill="none" stroke="#ffffff" stroke-width="2.3" stroke-linecap="round"/>
      <path d="M172 175 h14" stroke="#d1e3bc" stroke-width="2.8" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'snackPouch') return layer === 'front' ? wrap(`
    <g transform="translate(30,31)">
      <path d="M158 152 h30 v33 q0 7 -7 7 h-16 q-7 0 -7 -7 z" fill="#dfc160" stroke="#a78632" stroke-width="3"/>
      <path d="M160 155 q13 -10 26 0" fill="none" stroke="#719453" stroke-width="3" stroke-linecap="round"/>
      <circle cx="171" cy="171" r="4" fill="#e1a735"/><circle cx="180" cy="173" r="3" fill="#7d5a32"/><circle cx="175" cy="180" r="4" fill="#9b6b3e"/>
    </g>
  `) : '';
