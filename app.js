...
const UPGRADE_SLOTS = {
  ...
  S3: { slot: 'movement', label: 'movement upgrade', options: [
    { id: 'tinyWheels', name: 'Skates', emoji: '🛼' },
...
function renderAccessoryCardSvg(id) {
  ...
  if (id === 'judgeBadge') return wrap(`<circle cx="24" cy="22" r="8.5" fill="#5da2ff"/><circle cx="34" cy="15" r="8.2" fill="#ff5e5e"/><circle cx="45" cy="23" r="8.3" fill="#ffd449"/><circle cx="29" cy="31" r="8.2" fill="#6ed46d"/><circle cx="41" cy="33" r="7.8" fill="#b77cff"/><path d="M27 38 C28 48, 28 51, 28 54" stroke="#b06a34" stroke-width="1.7" stroke-linecap="round"/><path d="M33 37 C33 47, 33 50, 33 54" stroke="#b06a34" stroke-width="1.7" stroke-linecap="round"/><path d="M39 38 C39 47, 39 50, 39 54" stroke="#b06a34" stroke-width="1.7" stroke-linecap="round"/>`);
  if (id === 'tinyWheels') return wrap(`<path d="M15 38 q5 -7 12 0 l2 5 h-15 z" fill="#6fa04b" stroke="#35523a" stroke-width="2"/><path d="M39 38 q5 -7 12 0 l2 5 h-15 z" fill="#6fa04b" stroke="#35523a" stroke-width="2"/><rect x="17" y="30" width="12" height="10" rx="3" fill="#88bf49" stroke="#35523a" stroke-width="1.6"/><rect x="41" y="30" width="12" height="10" rx="3" fill="#88bf49" stroke="#35523a" stroke-width="1.6"/><circle cx="19" cy="47" r="3" fill="#ffb12d"/><circle cx="25" cy="47" r="3" fill="#ffb12d"/><circle cx="31" cy="47" r="3" fill="#ffb12d"/><circle cx="43" cy="47" r="3" fill="#ffb12d"/><circle cx="49" cy="47" r="3" fill="#ffb12d"/><circle cx="55" cy="47" r="3" fill="#ffb12d"/>`);
  ...
  if (id === 'cityBandana') return wrap(`<path d="M44 16 q7 2 7 8 q-7 2 -11 -3 q-2 -4 4 -5z" fill="#4f96ef"/><path d="M32 26 q8 2 8 9 q-8 2 -12 -3 q-2 -5 4 -6z" fill="#f4bc2e"/><path d="M48 35 q7 2 7 8 q-7 2 -11 -3 q-2 -5 4 -5z" fill="#8b62e8"/><path d="M22 39 q7 2 7 8 q-7 2 -11 -3 q-2 -5 4 -5z" fill="#ff7cac"/><path d="M14 27 q7 2 7 8 q-7 2 -11 -3 q-2 -5 4 -5z" fill="#5bcb64"/>`);
...
function renderAccessorySvg(upgrade, layer = 'front') {
  ...
  if (id === 'judgeBadge') return layer === 'front' ? wrap(`
    <g transform="translate(-98,-2)">
      <circle cx="175" cy="131" r="16" fill="#5da2ff"/><circle cx="191" cy="120" r="16" fill="#ff5e5e"/><circle cx="208" cy="133" r="16" fill="#ffd449"/><circle cx="183" cy="147" r="16" fill="#6ed46d"/><circle cx="203" cy="149" r="15" fill="#b77cff"/>
      <path d="M181 160 C181 180, 181 191, 181 204" stroke="#b06a34" stroke-width="2.8" stroke-linecap="round"/>
      <path d="M191 160 C191 180, 191 191, 191 207" stroke="#b06a34" stroke-width="2.8" stroke-linecap="round"/>
      <path d="M201 161 C201 180, 201 191, 201 205" stroke="#b06a34" stroke-width="2.8" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'tinyWheels') return layer === 'front' ? wrap(`
    <g transform="translate(0,4)">
      <path d="M84 223 q10 -12 24 0 l4 9 h-31 z" fill="#6fa04b" stroke="#35523a" stroke-width="3"/>
      <rect x="88" y="210" width="20" height="16" rx="4" fill="#88bf49" stroke="#35523a" stroke-width="2"/>
      <circle cx="89" cy="237" r="5" fill="#ffb12d"/><circle cx="99" cy="237" r="5" fill="#ffb12d"/><circle cx="109" cy="237" r="5" fill="#ffb12d"/>
      <path d="M145 223 q10 -12 24 0 l4 9 h-31 z" fill="#6fa04b" stroke="#35523a" stroke-width="3"/>
      <rect x="149" y="210" width="20" height="16" rx="4" fill="#88bf49" stroke="#35523a" stroke-width="2"/>
      <circle cx="150" cy="237" r="5" fill="#ffb12d"/><circle cx="160" cy="237" r="5" fill="#ffb12d"/><circle cx="170" cy="237" r="5" fill="#ffb12d"/>
    </g>
  `) : '';

  if (id === 'greenSneakers') return layer === 'back' ? wrap(`
    <g transform="translate(-2,-10)">
      <circle cx="54" cy="246" r="27" fill="none" stroke="#495057" stroke-width="4"/>
      <circle cx="212" cy="246" r="27" fill="none" stroke="#495057" stroke-width="4"/>
      <path d="M54 246 L110 198 L160 198 L212 246" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M110 198 L91 188" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
      <path d="M160 198 L178 188" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
      <path d="M160 198 L178 220" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
      <path d="M110 198 L136 246" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
      <path d="M136 246 L160 198" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
      <rect x="144" y="182" width="20" height="5" rx="2" fill="#7c5737"/>
      <path d="M178 188 l18 -9" fill="none" stroke="#5f8f56" stroke-width="5.5" stroke-linecap="round"/>
    </g>
  `) : '';

  if (id === 'sgBruneiScarf') return layer === 'front' ? wrap(`
    <g transform="translate(-14,-30)">
      <path d="M101 147 q34 14 67 0" fill="none" stroke="#d54e42" stroke-width="10" stroke-linecap="round"/>
      <path d="M104 156 q31 14 60 0" fill="none" stroke="#f2c142" stroke-width="10" stroke-linecap="round"/>
      <path d="M147 149 v36" stroke="#d54e42" stroke-width="8" stroke-linecap="round"/>
      <path d="M160 154 v33" stroke="#f2c142" stroke-width="8" stroke-linecap="round"/>
      <path d="M108 148 q12 -1 18 6" fill="none" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
      <circle cx="111" cy="148" r="1.4" fill="#ffffff"/><circle cx="116" cy="145.5" r="1.4" fill="#ffffff"/><circle cx="121.5" cy="148" r="1.4" fill="#ffffff"/>
    </g>
  `) : '';

  if (id === 'cityBandana') return layer === 'front' ? wrap(`
    <g transform="translate(24,-70)">
      <path d="M185 88 q12 3 12 13 q-12 3 -18 -5 q-3 -7 6 -8z" fill="#4f96ef"/>
      <path d="M162 107 q14 3 14 15 q-14 3 -20 -5 q-4 -8 6 -10z" fill="#f4bc2e"/>
      <path d="M196 122 q12 3 12 13 q-12 3 -18 -5 q-3 -7 6 -8z" fill="#8b62e8"/>
      <path d="M145 129 q12 3 12 13 q-12 3 -18 -5 q-3 -7 6 -8z" fill="#ff7cac"/>
      <path d="M132 104 q12 3 12 13 q-12 3 -18 -5 q-3 -7 6 -8z" fill="#5bcb64"/>
      <circle cx="171" cy="115" r="1.4" fill="#f1d75c"/><circle cx="184" cy="130" r="1.2" fill="#f1d75c"/><circle cx="156" cy="136" r="1.2" fill="#f1d75c"/>
    </g>
  `) : '';
