...
const UPGRADE_SLOTS = {
  S1: { slot: 'headgear', label: 'headgear upgrade', options: [
    ...
    { id: 'flowerCrown', name: 'Flower Hat', emoji: '🌼' }
  ]},
...
const STAMP_COLOUR_STAGES = [
  { stage: 1, family: 'Green family', description: 'leaf greens, moss, olive, lime, rooftop planting and green path', file: 'assets/stamp/stamp_stage_1.jpg' },
  { stage: 2, family: 'Blue family', description: 'sky, water, glass and cool blue transport details', file: 'assets/stamp/stamp_stage_2.jpg' },
  { stage: 3, family: 'Warm light family', description: 'sunlight, lantern glow, yellow, gold and amber highlights', file: 'assets/stamp/stamp_stage_3.jpg' },
  { stage: 4, family: 'Earth family + black', description: 'wood, brown, beige, skin tones, otter fur, baskets, paths and darker structure', file: 'assets/stamp/stamp_stage_4.jpg' },
  { stage: 5, family: 'Accent family + white finish', description: 'flowers, produce, pink, red, purple and final bright accents', file: 'assets/stamp/stamp_stage_5.jpg' }
];
...
function selectedUpgradeList(upgradesObj = state.upgrades) {
  return Object.values(upgradesObj || {}).filter(Boolean);
}

function getUpgradeSvg(id) {
  switch (id) {
    case 'farmerHat':
      return `<g class="avatar-upgrade headgear" aria-label="Farmer Hat">
        <ellipse cx="120" cy="39" rx="63" ry="14" fill="#d9b66e" stroke="#7a5128" stroke-width="4"/>
        <path d="M78 38c8-28 77-28 84 0-11 9-73 9-84 0Z" fill="#eacb84" stroke="#7a5128" stroke-width="4"/>
        <path d="M86 35c19 8 49 10 69 0" fill="none" stroke="#b98d45" stroke-width="3" stroke-linecap="round"/>
        <path d="M74 42c23 9 67 11 95 0" fill="none" stroke="#f7e0a1" stroke-width="2" stroke-linecap="round"/>
      </g>`;
    case 'flowerCrown':
      return `<g class="avatar-upgrade headgear" aria-label="Flower Hat">
        <ellipse cx="120" cy="37" rx="60" ry="13" fill="#d7b46e" stroke="#7a5128" stroke-width="4"/>
        <path d="M83 37c7-25 70-26 76 0-12 8-64 9-76 0Z" fill="#ead08b" stroke="#7a5128" stroke-width="4"/>
        <path d="M84 34c21 8 49 8 72 0" fill="none" stroke="#b27b3b" stroke-width="3" stroke-linecap="round"/>
        ${flowerSvg(84,28,'#ff86ad')} ${flowerSvg(103,22,'#ffd166')} ${flowerSvg(124,21,'#f783ac')} ${flowerSvg(145,28,'#b7eb63')}
      </g>`;
    case 'toteBadge':
      return `<g class="avatar-upgrade badge" aria-label="Reusable Tote Badge">
        <rect x="75" y="135" width="38" height="38" rx="7" fill="#fff4cf" stroke="#24784f" stroke-width="4"/>
        <path d="M84 137c2-14 20-14 22 0" fill="none" stroke="#24784f" stroke-width="4" stroke-linecap="round"/>
        <path d="M94 162c-4-8 2-14 9-19 1 10-1 17-9 19Z" fill="#2f9e44"/>
      </g>`;
    case 'judgeBadge':
      return `<g class="avatar-upgrade badge" aria-label="Green Judge Badge">
        <circle cx="97" cy="154" r="20" fill="#ffd166" stroke="#7a5128" stroke-width="4"/>
        <path d="M97 140l4 9 10 1-8 6 3 10-9-5-9 5 3-10-8-6 10-1Z" fill="#2fbf71"/>
        <path d="M88 171l-6 18 13-7 13 7-6-18Z" fill="#1f8f60"/>
      </g>`;
    case 'tinyWheels':
      return `<g class="avatar-upgrade movement" aria-label="Tiny Wheels">
        <circle cx="78" cy="232" r="13" fill="#63e6be" stroke="#0b5d5f" stroke-width="5"/>
        <circle cx="78" cy="232" r="5" fill="#fff"/>
        <circle cx="162" cy="232" r="13" fill="#63e6be" stroke="#0b5d5f" stroke-width="5"/>
        <circle cx="162" cy="232" r="5" fill="#fff"/>
        <path d="M62 218h36M142 218h36" stroke="#0b5d5f" stroke-width="6" stroke-linecap="round"/>
      </g>`;
    case 'greenSneakers':
      return `<g class="avatar-upgrade movement" aria-label="Green Sneakers">
        <path d="M54 218c16-6 36-3 44 9-5 10-40 13-54 3 0-5 3-9 10-12Z" fill="#38d27a" stroke="#174a34" stroke-width="4"/>
        <path d="M142 227c8-12 28-15 44-9 7 3 10 7 10 12-14 10-49 7-54-3Z" fill="#38d27a" stroke="#174a34" stroke-width="4"/>
        <path d="M65 220h22M153 220h22" stroke="#fff" stroke-width="4" stroke-linecap="round"/>
      </g>`;
    case 'sgBruneiScarf':
      return `<g class="avatar-upgrade neck" aria-label="SG–Brunei Scarf">
        <path d="M70 120c24 18 78 18 100 0v21c-28 14-72 14-100 0Z" fill="#f9d65c" stroke="#6f3f22" stroke-width="4"/>
        <path d="M83 125c12 8 62 8 75 0" stroke="#d12f2f" stroke-width="5" stroke-linecap="round"/>
        <path d="M107 137l-10 44 22-12 14 16 11-47Z" fill="#1f8f60" stroke="#6f3f22" stroke-width="4"/>
        <path d="M116 141l18 12M110 155l17 11" stroke="#fff" stroke-width="3" stroke-linecap="round"/>
      </g>`;
    case 'cityBandana':
      return `<g class="avatar-upgrade neck" aria-label="City Explorer Bandana">
        <path d="M72 122c30 14 66 14 96 0l-9 44c-20-11-58-11-78 0Z" fill="#4dabf7" stroke="#12303a" stroke-width="4"/>
        <path d="M91 139h58M101 152h39" stroke="#fff" stroke-width="4" stroke-linecap="round" opacity=".9"/>
        <path d="M114 130l8 15 8-15" fill="none" stroke="#b7eb63" stroke-width="4" stroke-linecap="round"/>
      </g>`;
    case 'reusableBottle':
      return `<g class="avatar-upgrade side" aria-label="Reusable Bottle">
        <path d="M175 134h28v12h-28Z" fill="#0b7285" stroke="#083d4b" stroke-width="4"/>
        <rect x="169" y="144" width="40" height="72" rx="13" fill="#4dabf7" stroke="#083d4b" stroke-width="5"/>
        <path d="M180 178c7-16 18-18 22-31 6 21 0 33-22 31Z" fill="#c3fae8"/>
        <path d="M179 196h21" stroke="#c3fae8" stroke-width="4" stroke-linecap="round"/>
      </g>`;
    case 'snackPouch':
      return `<g class="avatar-upgrade side" aria-label="Snack Pouch">
        <path d="M62 134c34 28 80 40 128 36" fill="none" stroke="#7a5128" stroke-width="5" stroke-linecap="round" opacity=".75"/>
        <rect x="166" y="166" width="42" height="48" rx="12" fill="#ffd166" stroke="#7a5128" stroke-width="5"/>
        <path d="M171 180h32" stroke="#b26b22" stroke-width="4" stroke-linecap="round"/>
        <circle cx="187" cy="197" r="7" fill="#ff922b"/>
      </g>`;
    default:
      return '';
  }
...
function flowerSvg(cx, cy, fill) {
  return `<g transform="translate(${cx} ${cy})">
    <circle cx="0" cy="0" r="5" fill="#ffd43b" stroke="#7a5128" stroke-width="1.2"/>
    <circle cx="0" cy="-8" r="6" fill="${fill}"/><circle cx="8" cy="0" r="6" fill="${fill}"/><circle cx="0" cy="8" r="6" fill="${fill}"/><circle cx="-8" cy="0" r="6" fill="${fill}"/>
  </g>`;
}

function getOtterSvg(upgradesObj = state.upgrades, opts = {}) {
  const upgrades = selectedUpgradeList(upgradesObj);
  const upgradeGroups = upgrades.map(u => getUpgradeSvg(u.id)).join('');
  const title = opts.title || 'Eco Otter mascot';
  return `<svg class="eco-otter-svg" viewBox="0 0 240 260" role="img" aria-label="${escapeHtml(title)}" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <filter id="softShadow" x="-20%" y="-20%" width="140%" height="150%"><feDropShadow dx="0" dy="6" stdDeviation="4" flood-color="#12303a" flood-opacity="0.18"/></filter>
    </defs>
    <g filter="url(#softShadow)">
      <path d="M150 185c42 5 68 24 63 43-5 18-45 22-82 4 11-12 16-28 19-47Z" fill="#86512f" stroke="#4a2d1c" stroke-width="5" stroke-linejoin="round"/>
      <ellipse cx="120" cy="157" rx="57" ry="71" fill="#9a643b" stroke="#4a2d1c" stroke-width="5"/>
      <ellipse cx="120" cy="165" rx="36" ry="50" fill="#f4d2a2" opacity=".95"/>
      <path d="M71 133c-23 16-29 45-12 61 15 14 31-3 27-28" fill="#8b5735" stroke="#4a2d1c" stroke-width="5" stroke-linecap="round"/>
      <path d="M169 133c23 16 29 45 12 61-15 14-31-3-27-28" fill="#8b5735" stroke="#4a2d1c" stroke-width="5" stroke-linecap="round"/>
      <circle cx="82" cy="66" r="20" fill="#875533" stroke="#4a2d1c" stroke-width="5"/>
      <circle cx="158" cy="66" r="20" fill="#875533" stroke="#4a2d1c" stroke-width="5"/>
      <ellipse cx="120" cy="80" rx="58" ry="51" fill="#a96d42" stroke="#4a2d1c" stroke-width="5"/>
      <ellipse cx="120" cy="96" rx="43" ry="30" fill="#f7d7ac"/>
      <ellipse cx="102" cy="83" rx="9" ry="11" fill="#10232a"/><ellipse cx="138" cy="83" rx="9" ry="11" fill="#10232a"/>
      <circle cx="99" cy="78" r="3" fill="#fff"/><circle cx="135" cy="78" r="3" fill="#fff"/>
      <path d="M112 96c4-6 12-6 16 0-2 6-14 6-16 0Z" fill="#10232a"/>
      <path d="M120 101c0 10-13 15-22 7M120 101c0 10 13 15 22 7" fill="none" stroke="#6b4025" stroke-width="4" stroke-linecap="round"/>
      <path d="M74 97c18-4 30-2 39 3M73 110c20-2 31 0 39 4M166 97c-18-4-30-2-39 3M167 110c-20-2-31 0-39 4" stroke="#6b4025" stroke-width="3" stroke-linecap="round" opacity=".65"/>
      <ellipse cx="85" cy="226" rx="31" ry="15" fill="#6f4329" stroke="#4a2d1c" stroke-width="5"/>
      <ellipse cx="155" cy="226" rx="31" ry="15" fill="#6f4329" stroke="#4a2d1c" stroke-width="5"/>
    </g>
    ${upgradeGroups}
  </svg>`;
}

function getUpgradeIconSvg(id) {
  const common = 'class="upgrade-icon-svg" viewBox="0 0 64 64" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"';
  const icons = {
    farmerHat: `<svg ${common}><ellipse cx="32" cy="35" rx="26" ry="7" fill="#d9b66e" stroke="#7a5128" stroke-width="3"/><path d="M17 34c4-18 27-18 31 0-8 5-23 5-31 0Z" fill="#eacb84" stroke="#7a5128" stroke-width="3"/><path d="M20 34c8 3 17 3 25 0" stroke="#b98d45" stroke-width="2" fill="none"/></svg>`,
    flowerCrown: `<svg ${common}><ellipse cx="32" cy="36" rx="26" ry="7" fill="#d9b66e" stroke="#7a5128" stroke-width="3"/><path d="M17 35c4-18 27-18 31 0-8 5-23 5-31 0Z" fill="#eacb84" stroke="#7a5128" stroke-width="3"/><circle cx="22" cy="29" r="5" fill="#ff86ad"/><circle cx="32" cy="26" r="5" fill="#ffd166"/><circle cx="42" cy="29" r="5" fill="#b7eb63"/></svg>`,
    toteBadge: `<svg ${common}><rect x="18" y="22" width="28" height="28" rx="5" fill="#fff4cf" stroke="#24784f" stroke-width="3"/><path d="M24 23c1-10 15-10 16 0" fill="none" stroke="#24784f" stroke-width="3"/><path d="M32 43c-4-7 1-12 8-16 1 9-1 14-8 16Z" fill="#2f9e44"/></svg>`,
    judgeBadge: `<svg ${common}><circle cx="32" cy="30" r="17" fill="#ffd166" stroke="#7a5128" stroke-width="3"/><path d="M32 18l4 8 9 1-7 6 2 9-8-5-8 5 2-9-7-6 9-1Z" fill="#2fbf71"/><path d="M24 44l-5 14 13-7 13 7-5-14Z" fill="#1f8f60"/></svg>`,
    tinyWheels: `<svg ${common}><path d="M16 28h32" stroke="#0b5d5f" stroke-width="5" stroke-linecap="round"/><circle cx="21" cy="40" r="11" fill="#63e6be" stroke="#0b5d5f" stroke-width="4"/><circle cx="43" cy="40" r="11" fill="#63e6be" stroke="#0b5d5f" stroke-width="4"/><circle cx="21" cy="40" r="4" fill="#fff"/><circle cx="43" cy="40" r="4" fill="#fff"/></svg>`,
    greenSneakers: `<svg ${common}><path d="M11 36c9-7 23-6 29 2-4 8-25 10-33 3 0-3 1-4 4-5Z" fill="#38d27a" stroke="#174a34" stroke-width="3"/><path d="M33 38c8-8 20-9 26-2 3 1 4 3 4 5-9 7-30 5-30-3Z" fill="#38d27a" stroke="#174a34" stroke-width="3"/><path d="M18 35h14M41 35h13" stroke="#fff" stroke-width="3"/></svg>`,
    sgBruneiScarf: `<svg ${common}><path d="M13 22c12 10 26 10 38 0v15c-14 8-24 8-38 0Z" fill="#f9d65c" stroke="#6f3f22" stroke-width="3"/><path d="M20 26c8 4 17 4 25 0" stroke="#d12f2f" stroke-width="3"/><path d="M30 36l-9 22 14-8 9 9 3-23Z" fill="#1f8f60" stroke="#6f3f22" stroke-width="3"/></svg>`,
    cityBandana: `<svg ${common}><path d="M13 22c15 8 23 8 38 0l-6 28c-10-8-16-8-26 0Z" fill="#4dabf7" stroke="#12303a" stroke-width="3"/><path d="M22 31h20M25 39h14" stroke="#fff" stroke-width="3"/></svg>`,
    reusableBottle: `<svg ${common}><rect x="25" y="10" width="14" height="9" rx="2" fill="#0b7285" stroke="#083d4b" stroke-width="3"/><rect x="20" y="18" width="24" height="39" rx="8" fill="#4dabf7" stroke="#083d4b" stroke-width="3"/><path d="M29 40c-3-7 1-12 7-18 3 11 0 17-7 18Z" fill="#c3fae8"/></svg>`,
    snackPouch: `<svg ${common}><path d="M11 21c16 15 26 19 43 18" fill="none" stroke="#7a5128" stroke-width="4"/><rect x="19" y="28" width="30" height="27" rx="7" fill="#ffd166" stroke="#7a5128" stroke-width="3"/><path d="M23 38h22" stroke="#b26b22" stroke-width="3"/><circle cx="34" cy="47" r="5" fill="#ff922b"/></svg>`
  };
  return icons[id] || `<svg ${common}></svg>`;
}

function renderOtter(upgradesObj = state.upgrades, mode = '') {
  return `<div class="otter-avatar ${escapeHtml(mode)}">${getOtterSvg(upgradesObj)}</div>`;
}

function renderOtterPanel(upgradesObj = state.upgrades, note = 'Your otter collects upgrades as your team clears checkpoints.') {
  return `<div class="otter-panel">${renderOtter(upgradesObj)}<div><strong>Eco Otter</strong><p>${escapeHtml(note)}</p></div></div>`;
}

function stampStageNumber() {
  const unlocked = Object.keys(state.stampLayers || {}).length;
  return Math.max(0, Math.min(5, unlocked));
}

function renderStampArt(stageOverride = null) {
  const stage = stageOverride ?? stampStageNumber();
  const stageMeta = STAMP_COLOUR_STAGES[Math.max(0, stage - 1)] || null;
  const src = stage > 0 ? STAMP_COLOUR_STAGES[stage - 1].file : 'assets/stamp/stamp_stage_1.jpg';
  const empty = stage <= 0;
  return `
    <div class="stamp-art colour-stamp ${empty ? 'empty' : ''}" aria-label="Collectible artwork colour-layer progress">
      ${empty ? '<div class="stamp-empty"><strong>Final artwork locked</strong><span>Complete checkpoints to reveal colour families.</span></div>' : `<img src="${escapeHtml(src)}" alt="Stamp artwork stage ${stage}" />`}
      ${stageMeta ? `<div class="stamp-caption"><strong>Layer ${stage}:</strong> ${escapeHtml(stageMeta.family)}</div>` : ''}
    </div>`;
}
...
function render() {
  if (location.hash === '#teacher') return renderTeacherLoginOrDashboard();
  if (state.mode === 'teacher') state.mode = 'student';
...
function downloadFinalOtter() {
  const svg = getOtterSvg(state.upgrades, { title: 'Completed Eco Otter avatar' });
  const blob = new Blob([svg], { type: 'image/svg+xml;charset=utf-8' });
  const url = URL.createObjectURL(blob);
  const safeGroup = (state.group || 'team').replace(/[^a-z0-9]+/gi, '_');
  const a = document.createElement('a');
  a.href = url;
  a.download = `${safeGroup}_Eco_Otter_Avatar.svg`;
  document.body.appendChild(a);
  a.click();
  a.remove();
  URL.revokeObjectURL(url);
  showToast('Eco Otter avatar downloaded.');
}
...
function renderUpgrade() {
  ...
  const previewFor = selectedId => {
    const option = cfg.options.find(o => o.id === selectedId);
    if (!option) return state.upgrades;
    return { ...state.upgrades, [code]: { ...option, slot: cfg.slot } };
  };
  app.innerHTML = `
    <section class="card upgrade-screen">
      ...
      <div id="upgradePreview" class="upgrade-preview">
        ${renderOtterPanel(chosen ? previewFor(chosen) : state.upgrades, chosen ? 'Previewing your selected upgrade.' : 'Choose an upgrade to preview it on your otter.')}
      </div>
      <h3>Choose one:</h3>
      <div class="grid two upgrade-choice-grid">
        ${cfg.options.map(opt => `<button type="button" class="option-card upgrade-choice ${chosen === opt.id ? 'selected' : ''}" data-upgrade="${escapeHtml(opt.id)}"><span class="upgrade-option-icon">${getUpgradeIconSvg(opt.id)}</span><div><strong>${escapeHtml(opt.name)}</strong><span>Tap to preview this upgrade on your otter.</span></div></button>`).join('')}
      </div>
  ...
  $$('[data-upgrade]').forEach(btn => btn.addEventListener('click', () => {
    ...
    const option = cfg.options.find(o => o.id === btn.dataset.upgrade);
    if (option) $('#upgradePreview').innerHTML = renderOtterPanel(previewFor(option.id), `${option.name} preview. This upgrade will be added if you confirm.`);
  }));
...
function renderStampReveal() {
  const code = currentStationCode();
  const nextLayer = Math.min(5, Object.keys(state.stampLayers || {}).length || 1);
  const meta = STAMP_COLOUR_STAGES[nextLayer - 1] || STAMP_COLOUR_STAGES[0];
  app.innerHTML = `
    <section class="card">
      <span class="kicker">Congratulations, Eco Ops Crew!</span>
      <h2>Colour Family Added</h2>
      <p>Your team has unlocked <strong>Layer ${nextLayer}: ${escapeHtml(meta.family)}</strong>.</p>
      <p>${escapeHtml(meta.description)}.</p>
      <p>Each checkpoint adds the next colour family. Unrevealed colours stay hidden until their layer is unlocked.</p>
      ${renderStampArt(nextLayer)}
...
function renderFinalScreen() {
  app.innerHTML = `
    <section class="card">
      ...
      <div class="actions row"><button class="secondary-btn" id="copySummary">Copy Completion Summary</button><button class="primary-btn" id="downloadAvatar">Download Final Eco Otter</button></div>
    </section>`;
  $('#copySummary').addEventListener('click', () => copyText(`Eco XP complete\nGroup: ${state.group}\nTeam: ${state.teamName}\nStations cleared: 5/5\nPhotos uploaded: ${photoCount()}/3`));
  $('#downloadAvatar').addEventListener('click', downloadFinalOtter);
}

function renderTeacherLoginOrDashboard() {
  state.mode = 'teacher';
  if (!teacherSessionPin) {
    app.innerHTML = `
      <section class="card">
        <span class="kicker">Teacher Dashboard</span>
        <h2>Teacher Login</h2>
        <p>Enter the teacher PIN to open dashboard viewing and scoring.</p>
    ...
    $('#teacherLogin').addEventListener('click', () => {
      ...
      teacherSessionPin = pin;
      localStorage.setItem(CONFIG.TEACHER_PIN_LOCAL_KEY, pin);
      renderTeacherDashboard();
    });
    $('#studentMode').addEventListener('click', () => { location.hash = ''; state.mode = 'student'; render(); });
  } else {
    renderTeacherDashboard();
  }
}
...
async function renderTeacherDashboard() {
  ...
  let data;
  try {
    data = await backend('getDashboard', { teacherPin: teacherSessionPin || localStorage.getItem(CONFIG.TEACHER_PIN_LOCAL_KEY) || '' });
  } catch (err) {
    console.error(err);
  ...
  $('#clearPin').addEventListener('click', () => { teacherSessionPin = ''; localStorage.removeItem(CONFIG.TEACHER_PIN_LOCAL_KEY); renderTeacherLoginOrDashboard(); });
  ...
  $$('[data-save-score]').forEach(btn => btn.addEventListener('click', async () => {
    ...
    try {
      await backend('saveScore', {
        teacherPin: teacherSessionPin || localStorage.getItem(CONFIG.TEACHER_PIN_LOCAL_KEY) || '',
        group,
...
if (teacherModeBtn) teacherModeBtn.addEventListener('click', () => { location.hash = '#teacher'; renderTeacherLoginOrDashboard(); });
window.addEventListener('hashchange', () => {
  if (location.hash === '#teacher') { renderTeacherLoginOrDashboard(); }
  else { state.mode = 'student'; render(); }
});
