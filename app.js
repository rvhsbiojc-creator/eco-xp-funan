...
function renderSplash() {
  ...
  $('[data-action="resume"]')?.addEventListener('click', () => {
    const target = ['splash', 'resume'].includes(entryScreen) ? (completedCount() >= 5 ? 'finalBase' : 'checkpoint') : entryScreen;
...
function renderCheckpoint() {
  ...
  app.innerHTML = `
    <section class="card">
      ...
      ${progressDots()}
      ${renderOtterPanel('Choose one upgrade. Your otter will wear it for the rest of the game.')}
