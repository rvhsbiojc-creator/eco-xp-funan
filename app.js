...
const OTTER_CANVAS = {
  width: 720,
  height: 760,
  base: { src: 'assets/otter/base_otter.png', x: 150, y: 42, w: 420, h: 680 },
  shadow: { x: 190, y: 675, w: 330, h: 42 },
  slots: {
    gardenHat: { x: 135, y: 15, w: 300, h: 160 },
    flowerHat: { x: 152, y: 16, w: 286, h: 150 },
    toteBadge: { x: 16, y: 246, w: 132, h: 184 },
    judgeBadge: { x: 324, y: 260, w: 88, h: 108 },
    tinyWheels: { x: 170, y: 548, w: 362, h: 156 },
    greenSneakers: { x: 70, y: 500, w: 580, h: 230 },
    sgBruneiScarf: { x: 360, y: 245, w: 170, h: 240 },
    cityBandana: { x: 164, y: 236, w: 180, h: 174 },
    reusableBottle: { x: 72, y: 500, w: 74, h: 142 },
    snackPouch: { x: 525, y: 514, w: 112, h: 140 }
  }
};
...
function renderAccessoryCardSvg(id) {
  const asset = OTTER_ASSET_MAP[id];
  if (!asset) return '';
  return `<img src="${asset.src}" class="upgrade-card-img" alt="" aria-hidden="true">`;
}
...
function renderAccessorySvg(upgrade) {
  ...
  if (id === 'gardenHat') return wrap(`
    <g transform="translate(0,-1)">
      ...
      <path d="M108 47 Q132 26 156 47" fill="none" stroke="#4d7f47" stroke-width="6" stroke-linecap="round"/>
      <path d="M142 23 q11 3 13 11 q-11 3 -16 -4 q-3 -5 3 -7z" fill="#5f8f56"/>
      <path d="M141 27 q6 -4 11 2" fill="none" stroke="#d8f0cd" stroke-width="2.4" stroke-linecap="round"/>
      <circle cx="122" cy="42" r="2.2" fill="#d8d46d"/><circle cx="131" cy="42" r="2.2" fill="#fff"/><circle cx="140" cy="42" r="2.2" fill="#f1c453"/>
    </g>
  `);
  ...
  if (id === 'flowerHat') return wrap(`
    <g transform="translate(0,-1)">
      ...
      <path d="M104 47 Q132 20 160 47 L156 55 Q132 60 108 55 Z" fill="#f4d38d" stroke="#bc9358" stroke-width="3"/>
      <g transform="translate(103 18)">
        <circle cx="14" cy="18" r="8" fill="#f58bac"/><circle cx="14" cy="18" r="2.3" fill="#fff4be"/>
        <circle cx="33" cy="13" r="10" fill="#fff3b2"/><circle cx="33" cy="13" r="2.4" fill="#fff"/>
        <circle cx="51" cy="19" r="8" fill="#ffcf73"/><circle cx="51" cy="19" r="2.2" fill="#fff"/>
        <circle cx="65" cy="15" r="7" fill="#f2a2bf"/><circle cx="65" cy="15" r="2" fill="#fff"/>
        <path d="M2 27 Q35 35 68 27" fill="none" stroke="#6cab5b" stroke-width="4" stroke-linecap="round"/>
      </g>
    </g>
  `);
  ...
  if (id === 'toteBadge') return wrap(`
    <g transform="translate(0,0)">
      <path d="M166 126 q16 12 20 39" fill="none" stroke="#7c5737" stroke-width="5" stroke-linecap="round"/>
      <path d="M159 150 h30 a5 5 0 0 1 5 5 v33 a7 7 0 0 1 -7 7 h-26 a7 7 0 0 1 -7 -7 v-33 a5 5 0 0 1 5 -5 z" fill="#dcd2b8" stroke="#809558" stroke-width="3"/>
      <path d="M167 152 q8 -10 16 0" fill="none" stroke="#809558" stroke-width="3" stroke-linecap="round"/>
      <path d="M168 171 q10 -14 20 0" fill="none" stroke="#729753" stroke-width="3" stroke-linecap="round"/>
      <path d="M170 175 q9 6 18 0" fill="none" stroke="#d3b34c" stroke-width="3" stroke-linecap="round"/>
      <path d="M162 184 h26" stroke="#809558" stroke-width="3" stroke-linecap="round"/>
    </g>
  `);

  if (id === 'judgeBadge') return wrap(`
    <g transform="translate(0,2)">
      <circle cx="132" cy="166" r="17" fill="#d8d2a1" stroke="#81935c" stroke-width="3"/>
      <path d="M123 179 l-5 16 12 -6 12 6 -5 -16" fill="#809558" opacity=".95"/>
  ...
  if (id === 'tinyWheels') return wrap(`
    <g transform="translate(0,3)">
      <path d="M93 230 h26 q2 0 3 2 l4 8 h-37 l4 -8 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="3"/>
      <path d="M143 230 h26 q2 0 3 2 l4 8 h-37 l4 -8 q1 -2 3 -2z" fill="#83a46d" stroke="#5c6c42" stroke-width="3"/>
      <circle cx="101" cy="245" r="6" fill="#3d454d"/><circle cx="118" cy="245" r="6" fill="#3d454d"/>
      <circle cx="151" cy="245" r="6" fill="#3d454d"/><circle cx="168" cy="245" r="6" fill="#3d454d"/>
    </g>
  `);

  if (id === 'greenSneakers') return wrap(`
    <g transform="translate(0,6)">
      <circle cx="95" cy="240" r="16" fill="none" stroke="#495057" stroke-width="4"/>
      <circle cx="170" cy="240" r="16" fill="none" stroke="#495057" stroke-width="4"/>
      <path d="M95 240 L122 214 L145 214 L170 240" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M122 214 L108 206" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M145 214 L166 208" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M145 214 L156 223" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <rect x="132" y="203" width="18" height="4" rx="2" fill="#7c5737"/>
      <rect x="147" y="200" width="13" height="4" rx="2" fill="#7c5737"/>
      <circle cx="133" cy="214" r="3.6" fill="#d2b559"/>
    </g>
  `);
  ...
  if (id === 'sgBruneiScarf') return wrap(`
    <g transform="translate(0,-2)">
      ...
      <path d="M144 139 v31" stroke="#d65746" stroke-width="9" stroke-linecap="round"/>
      <path d="M154 142 v27" stroke="#efb93f" stroke-width="9" stroke-linecap="round"/>
      <path d="M146 149 q4 0 8 0" stroke="#fff" stroke-width="2"/>
    </g>
  `);
  ...
  return `
    <div class="otter-wrap" aria-label="Eco Otter preview">
      <div class="otter-stage">
        ...
        <svg class="otter-overlay" viewBox="0 0 260 280" aria-hidden="true">${accessoryMarkup}</svg>
      </div>
    </div>`;
}
...
function buildOtterOverlaySvgMarkup() {
  const upgrades = Object.values(state.upgrades || {}).filter(Boolean);
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 280">${upgrades.map(renderAccessorySvg).join('')}</svg>`;
}
...
async function downloadFinalAvatar() {
  ...
  try {
    ...
    ctx.beginPath();
    ctx.ellipse(355, 690, 165, 22, 0, 0, Math.PI * 2);
    ctx.fill();

    const baseImg = await loadImageAsset('assets/otter/base_otter.png');
    ctx.drawImage(baseImg, 120, 36, 470, 690);

    const svg = buildOtterOverlaySvgMarkup();
    const overlayUrl = 'data:image/svg+xml;charset=utf-8,' + encodeURIComponent(svg);
    const overlayImg = await loadImageAsset(overlayUrl);
    ctx.drawImage(overlayImg, 120, 36, 470, 690);
