...
function renderAccessorySvg(upgrade, layer = 'front') {
  ...
  if (id === 'greenSneakers') return layer === 'back' ? wrap(`
    <g transform="translate(0,7)">
      <circle cx="88" cy="240" r="18" fill="none" stroke="#495057" stroke-width="4"/>
      <circle cx="177" cy="240" r="18" fill="none" stroke="#495057" stroke-width="4"/>
      <path d="M88 240 L119 211 L148 211 L177 240" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M119 211 L105 203" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M148 211 L168 204" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <path d="M148 211 L159 222" fill="none" stroke="#5f8f56" stroke-width="5" stroke-linecap="round"/>
      <rect x="134" y="200" width="18" height="4" rx="2" fill="#7c5737"/>
      <rect x="150" y="197" width="13" height="4" rx="2" fill="#7c5737"/>
      <circle cx="134" cy="211" r="3.6" fill="#d2b559"/>
    </g>
  `) : '';
